...
function Footer() {
  ...
  return (
    <div id="footer" className='d-flex flex-column align-items-around'>
      <div className='col-lg-12 d-flex justify-content-around p-5' >
        <div className='col-lg-2 d-flex flex-column align-items-between justify-content-between'>
          <div className='d-flex justify-content-around'>
            <a target='__blank' href="https://github.com/AJManzione">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="4vw" height="50" viewBox="0,0,256,256"
                style={{fill:"#000000"}}>
            ...
            <a target='__blank' href="https://www.youtube.com/@anthonymanzione3137">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="5vw" height="60" viewBox="0,0,256,256"
                style={{fill:"#000000"}}>
          ...
          <h6 className='text-center'>Anthony Manzione <span>© 2023</span></h6>
        </div>
