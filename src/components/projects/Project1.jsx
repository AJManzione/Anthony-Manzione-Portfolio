...
function Project1() {
  ...
  return (
    ...
    <div className='p-3' id='project-one-details'>
      <SlideUpFadeIn>
    ...
    <div className='project-technologies m-5'>
      ...
      <div className='col-lg-12 d-flex flex-column align-items-center p-3'>  
        <p className='text-center p-1'>Below are some of the key technologies used in the Mickey N' Friends Finder project.</p>
      </div>
      <SlideInFromRight>
      <div className='col-lg-12 d-flex flex-row align-items-center justify-content-around flex-wrap p-3'>
        <a target='__blank' href="https://html.com/html5/">
          <svg 
            xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" height="60" width="60" viewBox="0,0,256,256"
            style={{fill:"#000000"}}>
    ...
    <div className="project-presentation d-flex flex-column justify-content-center align-items-center p-5">
      <div className='col-lg-12 p-5 d-flex flex-column align-items-center'>
        <SlideInFromRight>
      ...
      <iframe className='big-movies-borderless' src="https://www.youtube.com/embed/ueMGiAj50o8" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
    </div>
  </div>
  )
}
