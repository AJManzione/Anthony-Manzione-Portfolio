        ...
        <div className="container mt-5">
          <div className="row">
            ...
            <div className="col-lg-4" >
              <Link to="/portfolio_anthony_manzione/mickey-n-friends-finder" title="Click Here To Learn More">
            ...
            <div className="col-lg-4">
              <Link to="/portfolio_anthony_manzione/wish-list" title="Click Here To Learn More">
                <figure className="effect-portfolio">
                  <div className="movies-container">
                    <div className="movies-overlay"></div>
                      {loaded2 ? (
            ...
            <div className="col-lg-4" >
              <Link to="/portfolio_anthony_manzione/pokedex-tracker" title="Click Here To Learn More">
                <figure className="effect-portfolio">
                  <div className="movies-container">
                    <div className="movies-overlay"></div>
                      {loaded3 ? (
