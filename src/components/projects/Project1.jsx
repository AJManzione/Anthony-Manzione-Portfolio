  ...
  return (
    ...
    <div className='m-3 ' id='about-MNFF-three'>
      ...
      <div className='col-lg-12 d-flex flex-column align-items-center p-3'>  
        <p className='text-center'>Below are some of the key technologies used in the Mickey N' Friends Finder project.</p>
      </div>
      <div className='col-lg-12 d-flex flex-row align-items-center justify-content-around flex-wrap p-5 ' ref={refSlideInRight3}>
        <a href="https://html.com/html5/">
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" height="100" width="100 " viewBox="0,0,256,256"
          style={{fill:"#000000"}}>
    ...
    <div id='about-MNFF-four' class="d-flex flex-column justify-content-center align-items-center p-5">
      <div className='col-lg-12 p-5 d-flex flex-column align-items-center' ref={refSlideInRight4}>
        <h1 style={{color:"white"}} className="title" >PRESENTATION</h1>
        <h5 style={{backgroundColor:"white"}} className='underline'></h5>
      </div>
