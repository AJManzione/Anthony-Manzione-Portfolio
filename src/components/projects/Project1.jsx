...
function Project1() {
  ...
  return (
    ...
    <div id='about-MNFF-two'>
      <div className='col-lg-12 p-5'>
        <h1 className="title text-center" ref={refSlideInRight}>MICKEY N' FRIENDS FINDER</h1>
        <h5 className="underline" ref={refSlideInLeft}></h5>
      </div>
      <div id='project-one-details' className="col-lg-12 d-flex flex-row justify-content-around flex-wrap mt-5 mb-5">
        <div className='col-lg-5 p-3' ref={refSlideInLeft2}>
        ...
        <div className="col-lg-5 p-3" ref={refSlideInRight2}>
    ...
    <div id='about-MNFF-three'>
      ...
      <div className='col-lg-12 d-flex flex-column align-items-centerp-1'>  
      ...
      <div className='col-lg-12 d-flex flex-row align-items-center justify-content-around flex-wrap p-5 ' ref={refSlideInRight3}>
        ...
        <a href="https://disneyapi.dev/">
          <h3 className='p-2' style={{color:'red'}}>Disney API</h3>
        </a>
        <a href="https://www.omdbapi.com/">
          <h3 className='p-2' style={{color:'red'}}>OMDB API</h3>
        </a>
